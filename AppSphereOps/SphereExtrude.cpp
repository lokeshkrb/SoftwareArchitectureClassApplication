...
Application::SphereExtrude* VersionUpExtrudeVersion2(Application::SphereExtrude2* oldFeature);
...
Application::SphereExtrude::SphereExtrude(std::string distance, std::string targetFace, std::string vectorObject, std::string isAddition, std::string isSubtraction, int guid)
...
std::string Application::SphereExtrude::GetVersion()
{
	return "3";
}
...
void ReadInExtrude(std::ifstream& streamObject)
{
	...
	Application::SphereExtrude* retVal = dynamic_cast<Application::SphereExtrude*>(extrudeReadInterface);

	Application::SphereExtrude2* retVal3 = dynamic_cast<Application::SphereExtrude2*>(retVal2);
	...
	if (retVal == nullptr)
	{
		...
		{
			Application::SphereExtrude2* extrudeVersion2 = dynamic_cast<Application::SphereExtrude2*>(extrudeReadInterface);
...
GuidObject* ReadExtrudeVersion2(std::ifstream& streamObject)
{
	...
	return new Application::SphereExtrude2(distance, targetFace, vectorObject, booleanType, guid);
...
Application::SphereExtrude* VersionUpExtrudeVersion2(Application::SphereExtrude2* oldFeature)
{
	Application::SphereExtrude* retval = nullptr;
	...
	retval = new Application::SphereExtrude(distance, targetFace, vectorObject, isAddition, isSubtraction, guid);
