...
namespace AutomationAPI
{
	...
	public:
		...
		SphereCollection* m_sphereCollection;
...
AutomationAPI::PartImpl::PartImpl(int guid)
{
	...
	m_sphereCollection = new SphereCollection(m_guid);
}
...
AutomationAPI::SphereCollection* AutomationAPI::PartImpl::Sphere()
{
	return m_sphereCollection;
}

AutomationAPI::SphereCollection* AutomationAPI::Part::Sphere()
{
	return m_partImpl->Sphere();
}
